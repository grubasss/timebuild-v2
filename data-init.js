const initialData = {
    ...
    entries: [
        // TYDZIEŃ 1
        { date: "2026-02-02", worker: "w1", project: "p1", hours: 8 },
        { date: "2026-02-02", worker: "w2", project: "p1", hours: 8 },
        { date: "2026-02-02", worker: "w3", project: "p2", hours: 6 },

        { date: "2026-02-03", worker: "w1", project: "p1", hours: 8 },
        { date: "2026-02-03", worker: "w2", project: "p1", hours: 8 },
        { date: "2026-02-03", worker: "w3", project: "p2", hours: 6 },

        { date: "2026-02-04", worker: "w1", project: "p1", hours: 7 },
        { date: "2026-02-04", worker: "w2", project: "p1", hours: 7 },
